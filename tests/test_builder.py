...
class TestPostgreSQLQueryBuilder(unittest.TestCase):
    def setUp(self):
        ...
        self._prefix = 'backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder.'
    ...
    @mock.patch('backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder._add_commands')
    ...
    @mock.patch('backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder._get_fields_string')
    ...
    @mock.patch('backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder._get_tables_string')
    ...
    @mock.patch('backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder._get_join_string')
    @mock.patch('backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder._get_join_type_command')
    ...
    @mock.patch('backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder._get_conditions_string')
    ...
    @mock.patch('backends.postgresql.postgresql_builder.PostgreSQLQueryBuilder._get_ordering_fields_string')
